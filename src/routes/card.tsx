					...
					description={{
						before: (
							<>
								...
								with and without links. You have to specify a
								title prop, but you can also add other props to
								change how the card looks. The default card will
								use cyan-20 as the background color. If you want
								to change this, you can pass in a bg prop with
								the value of the background you wan to use (see
...
/>`}
					description={{
						before: (
							<>
								You can also add an icon to the card. Please
								note that the only icons currently supported are
								font awesome. We might support other icons in
								the future, but for now you will have to use
								font awesome as the icon font. All font awesome
								icons are using the fa-regular font.
							</>
						),
					}}
				/>
